...
help:
	...
	@echo "  backend-run-agent      Run agent_server"
	@echo "  backend-run-controller Run controller_server"
	@echo "  backend-run-sniffer    Run packet_sniffer --list"
...
backend-run-agent:
	sudo ./$(BACKEND_BUILD_DIR)/agent_server

backend-run-controller:
	./$(BACKEND_BUILD_DIR)/controller_server

backend-run-sniffer:
	sudo ./$(BACKEND_BUILD_DIR)/packet_sniffer --list
